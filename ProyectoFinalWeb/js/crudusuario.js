function insertar() {
    ...
    var usuarios = JSON.parse(localStorage.getItem("usuarios") || "[]"); // <-- esto pasa de JSON A Obj
    usuarios.push(usuarioObjeto);

    localStorage.setItem("usuarios",JSON.stringify(usuarios))  // <-- esto pasa de Obj  A JSON
    // localStorage solo recibe String json 
